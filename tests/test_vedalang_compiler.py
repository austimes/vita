...
def test_compile_mini_plant():
    """Compile quickstart/mini_plant.veda.yaml to TableIR."""
...
def test_compile_example_with_timeslices():
    """Compile feature_demos/example_with_timeslices.veda.yaml to TableIR."""
    source = load_vedalang(
        EXAMPLES_DIR / "feature_demos/example_with_timeslices.veda.yaml"
    )
    tableir = compile_vedalang_to_tableir(source)
...
def test_compile_example_with_trade():
    """Compile feature_demos/example_with_trade.veda.yaml to TableIR.
    ...
    """
    source = load_vedalang(EXAMPLES_DIR / "feature_demos/example_with_trade.veda.yaml")
    tableir = compile_vedalang_to_tableir(source)
...
def test_all_examples_pass_semantic_validation():
    ...
    """
    example_files = sorted(EXAMPLES_DIR.rglob("*.veda.yaml"))
...
def test_toy_refactored_examples_compile_under_new_invariants():
    for filename in (
        "toy_sectors/toy_buildings.veda.yaml",
        "toy_sectors/toy_industry.veda.yaml",
        "toy_sectors/toy_transport.veda.yaml",
